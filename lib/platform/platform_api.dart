...
class PlatformApi {
  ...
  /// Opens a `content://` URI and hands back a descriptor for it. Android only.
  ///
  /// The descriptor is detached, so **the caller owns it** and must call
  /// `DataPlane.closeDescriptor` on any path where the data plane does not
  /// adopt it.
