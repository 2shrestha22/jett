...
void main() {
  ...
  File('rust/tests/fixtures/dart_identity.pem').writeAsStringSync(keys.certificatePem);
  File('rust/tests/fixtures/dart_identity.key').writeAsStringSync(keys.privateKeyPem);
  File('rust/tests/fixtures/dart_identity.fingerprint').writeAsStringSync(keys.fingerprint);
